      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-50 flex flex-col rounded-2xl border border-[#d2d2d7] dark:border-[#3a3a3c] shadow-2xl bg-[#f5f5f7] dark:bg-[#1c1c1e]"
            style={{
              width: "360px",
          ...
          >
                ...
                >
                  <div
                    className={`max-w-[80%] px-4 py-2.5 text-sm leading-relaxed ${
                      msg.role === "user"
                        ? "bg-[#1d1d1f] dark:bg-[#f5f5f7] text-[#f5f5f7] dark:text-[#1d1d1f] rounded-2xl rounded-br-md"
            ...
            <div className="px-4 py-3 border-t border-[#d2d2d7] dark:border-[#3a3a3c] backdrop-blur-md rounded-b-2xl flex items-center gap-2">
              ...
              <motion.button
                ...
                className="w-8 h-8 rounded-full flex items-center justify-center bg-[#1d1d1f] dark:bg-[#f5f5f7] text-[#f5f5f7] dark:text-[#1d1d1f] disabled:opacity-40 transition-opacity"
              >
