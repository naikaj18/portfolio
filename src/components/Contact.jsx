...
const Contact = () => {
  return (
    <section id="contact" className="py-28 border-t border-[#d2d2d7] dark:border-[#3a3a3c]">
      <motion.p
      ...
      <motion.h2
        ...
        viewport={{ once: true }}
        className="text-3xl lg:text-4xl font-semibold tracking-tight text-[#1d1d1f] dark:text-[#f5f5f7] leading-tight mb-4"
      >
      ...
      >
        ...
        <p className="text-xs text-[#6e6e73] dark:text-[#98989d]">
          AI &amp; Cloud Engineer · San Francisco
        </p>
      </motion.div>
    </section>
  );
