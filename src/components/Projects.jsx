              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {project.technologies.map((tech, i) => (
                    <span
                      key={i}
                      className="text-xs px-2.5 py-1 rounded-full bg-[#faf7f2] dark:bg-white/10 dark:backdrop-blur-sm border border-[#e5e5ea] dark:border-white/10 text-[#1d1d1f] dark:text-[#f5f5f7]"
                    >
                      {tech}
                    </span>
                  ))}
